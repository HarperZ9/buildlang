...
slice in addition to compile-only metadata validation. Five semantic corpus
...
receipt consistency and metadata tests keep the execution receipt aligned with
the manifest.

...
impl DwarfGenerator {
    ...
    pub fn new() -> Self {
        Self {
            version: 4,
            address_size: 8,
            producer: "BuildLang Compiler 1.0".to_string(),
            comp_dir: String::new(),
            files: Vec::new(),
            directories: Vec::new(),
    ...
    pub fn build_from_mir(&mut self, mir: &MirModule) {
        ...
        cu.add_attr(
            DwarfAttr::Language,
            DwarfAttrValue::Data2(DwarfLang::BuildLang as u16),
        );
        cu.add_attr(
            DwarfAttr::Name,
    ...
    pub fn generate_assembly(&self) -> String {
        ...
        writeln!(output, "# Generated by BuildLang Compiler").unwrap();
...
mod tests {
    ...
    #[test]
    fn test_dwarf_lang_buildlang() {
        assert_eq!(DwarfLang::BuildLang as u16, 0x8001);
    }

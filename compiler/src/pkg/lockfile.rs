...
//!
//! The lockfile (`Build.lock`) records exact versions of all dependencies
...
/// Lockfile name
pub const LOCKFILE_NAME: &str = "Build.lock";
...
impl Lockfile {
        ...
        for (name, pkg) in &resolution.packages {
            let locked = LockedPackage {
                ...
                source: PackageSource::Registry {
                    registry: "https://registry.buildlang.org".to_string(),
                },
                checksum: None,
    ...
    pub fn serialize(&self) -> Result<String, LockfileError> {
        ...
        writeln!(
            output,
            "# This file is automatically generated by build-pkg."
        )?;
...
mod tests {
    ...
    fn test_package_source_parse() -> Result<(), LockfileError> {
        let registry = PackageSource::parse("registry+https://registry.buildlang.org")?;

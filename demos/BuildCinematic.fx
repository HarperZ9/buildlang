// BuildCinematic.fx - Complete ReShade Cinematic Post-Processing
// All math functions compiled from BuildLang source (cinematic.bld)
...
// Technique
// ============================================================
technique BuildCinematic <
    ui_label = "Build Cinematic";
    ui_tooltip = "Vignette + Film Grain + Lift/Gamma/Gain\nCompiled from BuildLang";
> {
    pass {

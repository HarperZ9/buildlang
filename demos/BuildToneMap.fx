// BuildToneMap.fx - Complete ReShade Effect
// Generated helper functions by BuildLang Compiler
// ReShade integration by hand (until texture sampling intrinsics ship)
//
// Usage: Drop this file into reshade-shaders/Shaders/
// Workflow: buildc reshade_tonemap.bld --target hlsl -o reshade_tonemap.fx
...
// ============================================================
// BuildLang-Generated Functions
// Source: reshade_tonemap.bld
// Compiled: buildc reshade_tonemap.bld --target hlsl
// ============================================================
...
// Technique
// ============================================================
technique BuildToneMap <
    ui_label = "Build Tone Map";
    ui_tooltip = "ACES filmic tone mapping - compiled from BuildLang";
> {
    pass {

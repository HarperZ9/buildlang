...
```bash
git worktree add ../buildlang-<branch-name> -b <branch-name>
```
...
- Use the naming convention `buildlang-<branch-name>` for worktree directories

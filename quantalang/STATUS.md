...
The `Quanta.toml` manifest claims 21,785 lines and lists module line counts, but these are self-reported and the code has grown well beyond that. A live repository count on 2026-06-15 shows 217,961 lines in `src/`, 26,124 in `stdlib/`, and 7,505 in `tests/`.

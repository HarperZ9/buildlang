# Future: Self-Hosted QuantaLang

This directory contains the aspirational self-hosted QuantaLang implementation.
**This code cannot be compiled by the current compiler.**

When QuantaLang gains module imports, trait dispatch, and a standard library,
this code will become the target for self-hosting - a compiler that compiles itself.

## Contents
- `self-hosted-compiler/` - Compiler written in QuantaLang

...
%build_vec2 = type { double, double }
%build_vec3 = type { double, double, double }
%build_vec4 = type { double, double, double, double }


; Runtime types
%BuildString = type { ptr, i64, i64 }

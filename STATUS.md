...
- **Current CI-shaped cargo baseline (2026-06-14)**: 724 passed, 0 failed, 10 ignored, 4 filtered across the compiler test binaries via `cargo test -- --skip spirv::tests::test_triangle --skip spirv::tests::test_write` from `compiler/`.
...
## Honest Line Counts
- Compiler (Rust, `compiler/src/`): 93,168 lines -- STATUS: working core (lexer, parser, types, C backend), partial other backends/tools
- Integration Tests (Rust, `compiler/tests/`): 4,035 lines -- STATUS: working

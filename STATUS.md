...
- **Current cargo baseline (2026-06-13)**: 643 passed, 0 failed, 11 ignored across the compiler test binaries via `cargo test --manifest-path compiler/Cargo.toml --quiet`.

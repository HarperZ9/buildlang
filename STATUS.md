...
- **Current CI-shaped cargo baseline (2026-06-14)**: 803 passed, 0 failed, 10 ignored, 4 filtered across the compiler test binaries via `cargo test -- --skip spirv::tests::test_triangle --skip spirv::tests::test_write` from `compiler/`.
...
## Honest Line Counts
- Compiler (Rust, `compiler/src/**/*.rs`): 97,517 lines -- STATUS: working core (lexer, parser, types, C backend), partial other backends/tools
- Integration Tests (Rust, `compiler/tests/`): 8,402 lines -- STATUS: working

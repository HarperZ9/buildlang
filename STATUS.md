...
- **Header-backed + link FFI update (2026-06-29)**: added 18 tests for the `header "..."` and `link "..."` clauses (7 parser, 3 lowering, 7 C-backend/GeneratedCode, 1 `user_link_flags`). `cargo test --quiet` from `compiler/` stays green (lib 769, bin 44, integration 260; 0 failed) and `RUSTFLAGS=-Dwarnings cargo build` is clean.

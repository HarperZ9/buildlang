...
This is the first stable release of BuildLang, a modern systems programming language
...
#### Package Management
- `build new`: Create new project
- `build add`: Add dependencies
- `build remove`: Remove dependencies
...
BuildLang follows Semantic Versioning:
...
- Editions are opt-in via `edition` in `build.toml`
- Old code continues to work unchanged
- Automatic migration tools provided

---

[1.0.0]: https://github.com/buildlang/buildlang/releases/tag/v1.0.0
[0.9.0]: https://github.com/buildlang/buildlang/releases/tag/v0.9.0
[0.8.0]: https://github.com/buildlang/buildlang/releases/tag/v0.8.0
[0.7.0]: https://github.com/buildlang/buildlang/releases/tag/v0.7.0
[0.6.0]: https://github.com/buildlang/buildlang/releases/tag/v0.6.0
[0.5.0]: https://github.com/buildlang/buildlang/releases/tag/v0.5.0
[0.1.0]: https://github.com/buildlang/buildlang/releases/tag/v0.1.0

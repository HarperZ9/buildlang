# BuildLang Standard Library Reference

The BuildLang standard library provides essential functionality for building applications. This document provides a comprehensive reference for all modules.

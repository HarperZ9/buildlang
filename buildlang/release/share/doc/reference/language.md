...
This document provides a complete reference for the BuildLang programming language.
...
This reference covers the core language features. For the complete specification, see the [BuildLang Specification](specification.md).

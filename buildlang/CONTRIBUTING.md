# Contributing to BuildLang

Thank you for your interest in contributing to BuildLang! This document provides guidelines and instructions for contributing.
...
- [ ] Code is formatted (`build fmt`)
- [ ] Linter passes (`build lint`)
...
///
/// ```
/// let ast = parse("fn main() {}", "main.bld")?;
/// ```
///
/// # Errors
///
...
Thank you for contributing to BuildLang! 🎉

# BuildLang v1.0.0 Release Checklist Draft
...
### Tooling
- [x] `build build` - Compiler
- [x] `build run` - Build and execute
- [x] `build test` - Test runner
- [x] `build fmt` - Formatter
- [x] `build lint` - Linter
- [x] `build doc` - Documentation generator
- [x] `build repl` - Interactive shell
- [x] `build pkg` - Package manager
...
- [x] Install script
- [x] Package configuration (build.toml)
